...
ALLOWED_HOSTS = ['rentui-kg.vercel.app', 'localhost', '127.0.0.1', '.vercel.app']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Важно: используйте BASE_DIR
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Указывает путь к папке static в корне вашего проекта
STATICFILES_DIRS = [
    BASE_DIR / "static", 
]
